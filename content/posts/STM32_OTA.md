...
远程升级技术OTA（Over-The-Air）；无需通过JTAG等方式进行烧录，通过无线通信实现固件动态更新，方便快捷。
...
- [1. STM32启动流程](#1-stm32启动流程)
- [2. Flash分区设计](#2-flash分区设计)
- [3. Bootloader核心功能实现](#3-bootloader核心功能实现)
- [4. Flash读写操作详解](#4-flash读写操作详解)
- [5. 通信协议实现](#5-通信协议实现)
- [6. 固件加密与安全](#6-固件加密与安全)
- [7. 异常处理与容错机制](#7-异常处理与容错机制)
- [8. 完整项目实战总结](#8-完整项目实战总结)
- [9. 总结与最佳实践](#9-总结与最佳实践)
...
详细启动流程见[STM32_bootloader](https://virongx.com/blog/STM32_bootloader/)，此处仅简述与OTA相关的部分。
